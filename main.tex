...
previous section). Let $M_0(V)$ be the space of (density) functions on
$V$ such that $\sum_{z \in V} \xi(z) \rho(z) = 0$, cf.
...
the graph and a change of sign in the coefficients of the linear
