...
inner products with the weights $\theta$ and $\rho$ respectively on
the edge set $\setof{\set{x,y}}{E(x,y)=1}$ and the vertex set $V$.
...
$M_0(V)$ is a subspace for $L(V)$ of co-dimension 1. Notice that
$\phi \in L(V)$ and $\xi \in M_0(V)$ implies that for some $a$
\begin{multline*}
  \xi(z) =
...
Now, the \emph{Arens-Eells} norm of $\xi$ is defined in
\citep{montrucchio|pistone:2019-arXiv:1905.07547} as
\begin{multline*}
